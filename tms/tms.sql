...
(2, 'privacy', '										<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\">Our commitment to your privacy extends to your physical security during your hotel stay booked through TMS. We partner exclusively with hotels that enforce rigorous security protocols, including 24/7 surveillance, secure keycard access systems, and compliance with local privacy laws regarding guest data handling. Any sensitive information shared with the hotel (such as copies of ID or passport upon check-in) is managed by the hotel partner under their own robust data protection policies. TMS ensures that the minimum necessary personal data is transferred to the hotel to facilitate a smooth, secure check-in process, thereby protecting your personal information from unnecessary exposure while prioritizing your safety and peace of mind throughout your accommodation.</span>\r\n										'),
...
(11, 'contact', '																				<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\">Address------J-Da Nang, Quang Nam -211025</span>');
