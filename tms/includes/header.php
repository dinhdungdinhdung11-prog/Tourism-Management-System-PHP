...
<div class="top-header">
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			...
			<li class="prnt"><a href="issuetickets.php">Vé hỗ trợ đã tạo</a></li>
		</ul>
...
<div class="top-header">
	<div class="container">
		...
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Hotline : 123-4568790</li>				
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">Hệ thống <span>Quản lý Du lịch</span></a>	
		</div>
	...
	<div class="container">
		<div class="navigation">
			<nav class="navbar navbar-default">
				<!-- Nút toggle khi hiển thị trên thiết bị di động -->
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					<span class="sr-only">Chuyển menu</span>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<?php if($_SESSION['login']) { ?>
								<li>Cần hỗ trợ?<a href="#" data-toggle="modal" data-target="#myModal3"> / Gửi yêu cầu </a></li>
							<?php } else { ?>
								<li><a href="enquiry.php">Gửi yêu cầu</a></li>
							<?php } ?>
							<div class="clearfix"></div>
						</ul>
					</nav>
