...
<p style="width: 350px;">
    <b>Email</b>
    <input type="email" name="email" class="form-control" id="email" placeholder="Nhập email đã đăng ký" required="">
</p> 

<p style="width: 350px;">
    <b>Số điện thoại</b>
    <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Nhập số điện thoại đã đăng ký" required="">
</p> 
...
<p style="width: 350px;">
    <button type="submit" name="submit50" class="btn-primary btn">Đổi mật khẩu</button>
</p>
</form>
